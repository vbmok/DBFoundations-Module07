...
-- 2023-11-29,VMok,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_VMok')
	 Begin 
	  Alter Database [Assignment07DB_VMok] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_VMok;
	 End
	Create Database Assignment07DB_VMok;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_VMok;
